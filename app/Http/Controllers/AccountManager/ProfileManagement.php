...
class ProfileManagement extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('user-account-manager.profile-management.index', [
            "cities" => $cities,
            "provinces" => $provinces,
            "user" => $user
        ]);
    ...
    public function updateProfile(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route("account-manager.profile-management", ["#update-profile"])
    ...
    public function updatePassword(Request $request)
    {
        ...
        if (!Hash::check($data->current_password, $user->password)) {
            return redirect()->route("account-manager.profile-management", ["#change-password"])
                ->withInput($request->all())
