...
class ParentManagement extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('user-account-manager.parent-management.index', [
            "parents" => $parents
        ]);
    }
    public function new(Request $request)
    {
        ...
        return view('user-account-manager.parent-management.new', [
            "cities" => $cities,
            "provinces" => $provinces,
        ]);
    }
    public function create(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('account-manager.parent-management.view', ['parent' => $parent->id])
    ...
    {
        return view('user-account-manager.parent-management.view', [
            "parent" => $parent
        ]);
    }
    public function edit(User $parent, Request $request)
    {
        ...
        return view("user-account-manager.parent-management.edit", [
            "provinces" => $provinces,
            "cities" => $cities,
            "parent" => $parent
        ]);
    ...
    public function update(User $parent, Request $request)
    {
        ...
        try {
            ...
            return redirect()->route("account-manager.parent-management.edit", ['parent' => $parent->id])
                ->with(["success-message" => "Successfully created the parent account."]);
        } catch (Exception $e) {
            return redirect()->back()
                ->withInput($request->all())
