...
class StudentDepartedNotification extends Notification
{
    use Queueable;
    ...
    public function toNotifySms($notifiable)
    {
        ...
        return [
            "message" => "Hi {$notifiable->firstname},\nYour child {$student->firstname} {$student->lastname} departed from the school at {$arrivelDateTime->format("H:i A")}.",
