        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="{{ route('account-manager.student-management.view', ['student' => $student->id]) }}">Student
                        #{{ $student->id }}</a></li>
...
@section('content-main')
    <main class="menu-content-body">
        ...
        <div class="bg-white shadow-lg w-100 rounded p-4">
            ...
            <form action="{{ route('account-manager.student-management.view.attendances', ['student' => $student->id]) }}" method="get">
                <div class="row g-2">
                    <div class="col-md">
