...
@section('content-head')
    <div class="menu-content-head">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('parent-management') }}">Parents</a></li>
                <li class="breadcrumb-item"><a href="javascript:void(0)">Edit #{{ $parent->id }}</a></li>
            </ol>
        </nav>
    </div>
@endsection
...
@section('content-main')
    <main class="menu-content-body">
        ...
        <div class="bg-white shadow-lg w-100 rounded p-4">
            ...
            <form action="{{ route('account-manager.parent-management.edit', ['parent' => $parent->id]) }}" method="post">
                @csrf
                <div>
                    <div class="form-floating">
                        <input type="text" class="form-control   @error('email') is-invalid @enderror" id="email"
                            name="email" placeholder="email" value="{{ old('email') ?? $parent->email }}" required>
                    ...
                    <div class="form-floating mt-2">
                        <input type="text" class="form-control   @error('firstname') is-invalid @enderror" id="firstname"
                            name="firstname" placeholder="Firstname" value="{{ old('firstname') ?? $parent->firstname }}"
                            required>
                    ...
                    <div class="form-floating mt-2">
                        <input type="text" class="form-control   @error('lastname') is-invalid @enderror" id="lastname"
                            name="lastname" placeholder="Lastname" value="{{ old('lastname') ?? $parent->lastname }}"
                            required>
                    ...
                    <div class="form-floating mt-2">
                        <input type="text" class="form-control @error('phone_number') is-invalid @enderror"
                            ...
                            value="{{ old('phone_number') ?? $parent->telephone }}">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control @error('address_line_1') is-invalid @enderror"
                            ...
                            value="{{ old('address_line_1') ?? $parent->address_line_1 }}" required>
                    ...
                    <div class="form-floating mt-2">
                        <input type="text" class="form-control @error('address_line_2') is-invalid @enderror"
                            ...
                            value="{{ old('address_line_2') ?? $parent->address_line_2 }}" required>
                    ...
                    <div class="form-floating mt-2">
                        <input type="text" class="form-control @error('address_line_3') is-invalid @enderror"
                            ...
                            value="{{ old('address_line_3') ?? $parent->address_line_3 }}">
                    ...
                    <div class="form-floating mt-2">
                        <select class="form-select @error('city') is-invalid @enderror" id="city" name="city"
                            ...
                            @foreach ($cities as $city)
                                <option value="{{ $city->id }}" @if ((old('city') ?? $parent->city_id) == $city->id) selected @endif>
                                    {{ $city->name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-floating mt-4">
                        <select class="form-select @error('is_active') is-invalid @enderror" id="is_active" name="is_active"
                            aria-label="Is Active" required>
                            <option selected disabled value="-1">Choose one</option>
                            <option value="0" @if ((old('is_active') ?? $parent->is_active) == 0) selected @endif>Deactivated</option>
                            <option value="1" @if ((old('is_active') ?? $parent->is_active) == 1) selected @endif>Activated</option>
                        </select>
