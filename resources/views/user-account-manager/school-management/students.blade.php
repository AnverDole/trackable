...
@section('content-main')
    <main class="menu-content-body">
        ...
        <div class="bg-white shadow-lg w-100 rounded p-4">
            ...
            <form action="{{ route('account-manager.school-management.students', ['school' => $school->id]) }}" method="get">
                <div class="row g-2">
                    <div class="col-md">
        ...
        @if ($students->count() > 0)
            <div class="w-100 mt-4 container">
                @foreach ($students as $student)
                    <a href="{{ route('account-manager.student-management.view', ['student' => $student->id]) }}" target="_new"
