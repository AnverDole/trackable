...
@section('content-head')
    <div class="menu-content-head">
        <h1><i class="fa-solid fa-user-group"></i>Attendances - School #{{$school->id}}</h1>
...
@section('content-main')
    <main class="menu-content-body">
        ...
        <div class="bg-white shadow-lg w-100 rounded p-4">
            ...
            <form action="{{ route('account-manager.school-management.view.attendances', ['school' => $school->id]) }}" method="get">
                <div class="row g-2">
                    <div class="col-md">
                    ...
                    <div class="bg-white text-dark text-decoration-none  shadow row rounded p-2 school mt-3">
                        ...
                        <div class="col-12 col-lg-3 d-flex flex-column align-lg-items-end">
                            <div class="d-flex flex-column">
                                ...
                                <span>{{ $attendance->Student->created_at->format('Y-m-d H:i A') }}</span>
                            </div>
                        </div>
                    </div>
                @endforeach
