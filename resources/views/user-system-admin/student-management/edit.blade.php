    ...
    <div class="menu-content-head">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('student-management.edit', ['student' => $student->id]) }}">Edit
                        #{{ $student->id }}</a></li>
            </ol>
        </nav>
    </div>
...
@section('content-main')
    <main class="menu-content-body">
        <div class="bg-white shadow-lg w-100 rounded p-4">
            ...
            <form action="{{ route('student-management.edit', ['student' => $student->id]) }}" method="post">
                @csrf
                <div class="mt-4">
