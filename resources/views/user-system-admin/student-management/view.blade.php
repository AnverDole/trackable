            ...
            <div class="row">
                <div class="bg-white shadow-lg w-100 rounded p-4">
                    ...
                    <div class="mt-4">
                        ...
                        <a href="{{ route('student-management.edit', ['student' => $student->id]) }}"
                            class="btn btn-light me-2"><i class="fa-solid fa-pen"></i>&nbsp;Edit</a>
                        <a href="{{ route('student-management.view.attendances', ['student' => $student->id]) }}"
                ...
                <div class="mt-4 p-0 ">
                    ...
                    <div class="container">
                        <a href="{{ route('school-management.view', ['school' => $student->School->id]) }}" target="_new"
    ...
    <div class="modal fade" id="confirm-associate-new-school" tabindex="-1"
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <form action="{{ route('student-management.school.associate', ['student' => $student->id]) }}"
                    method="post">
                    @csrf
