...
@section('content-head')
    <div class="menu-content-head">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('student-management') }}">Parent Management</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="bg-white shadow-lg w-100 rounded p-4">
                    ...
                    <div class="mt-4">
                        <a href="{{ route('parent-management') }}" class="btn btn-light me-2"><i
                                class="fa-solid fa-circle-arrow-left"></i>&nbsp;Back</a>
                        <a href="{{ route('parent-management.edit', ['parent' => $parent->id]) }}"
                    ...
                    <div class="mt-4 p-0 ">
                        ...
                        <div class="container">
                            @foreach ($parent->Childs as $child)
                                <a href="{{ route('student-management.view', ['student' => $child->id]) }}" target="_blank"
                                    target="_new"
