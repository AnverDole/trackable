...
@include('user-system-admin.parent-management.navigation')
...
@section('content-main')
    <main class="menu-content-body">
        ...
        <div class="bg-white shadow-lg w-100 rounded p-4">
            <h4>Search Parent</h4>
            <form action="{{ route('parent-management') }}" method="get">
                <div class="row g-2">
                    <div class="col-md">
        ...
        @if ($parents->count() > 0)
            <div class="w-100 mt-4 container">
                @foreach ($parents as $parent)
                    <a href="{{ route('parent-management.view', ['parent' => $parent->id]) }}"
